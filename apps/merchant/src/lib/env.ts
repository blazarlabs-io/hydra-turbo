...
const raw = {
  // Firebase Client
  FB_API_KEY: read('FB_API_KEY'),
  FB_AUTH_DOMAIN: read('FB_AUTH_DOMAIN'),
  FB_PROJECT_ID: read('FB_PROJECT_ID'),
  FB_STORAGE_BUCKET: read('FB_STORAGE_BUCKET'),
  FB_MESSAGING_SENDER_ID: read('FB_MESSAGING_SENDER_ID'),
  FB_APP_ID: read('FB_APP_ID'),
  FB_MEASUREMENT_ID: read('FB_MEASUREMENT_ID'),
